  ...
  render() {
    ...
    return (
      <View>
        ...
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>Nota 1:</Text>
          <TextInput
            style={styles.tableCell}
            placeholder="Nota 1"
        ...
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>Nota 2:</Text>
          <TextInput
            style={styles.tableCell}
            placeholder="Nota 2"
        ...
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>Nota 3:</Text>
          <TextInput
            style={styles.tableCell}
            placeholder="Nota 3"
        ...
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>Definitiva:</Text>
          <Text style={styles.tableCell}>{this.state.definitiva}</Text>
        </View>
        <View style={styles.tableRow}>
  <Text style={styles.tableCell}>Observación:</Text>
  <Text style={[
    styles.tableCell,
    this.state.observacion === 'Gana' ? styles.observacionGana :
    this.state.observacion === 'Pierde' ? styles.observacionPierde :
    this.state.observacion === 'Habilita' ? styles.observacionHabilita : {}
  ]}>
